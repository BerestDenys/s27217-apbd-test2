...
namespace _27217_apbd_test2.Migrations
{
    ...
    [Migration("20250613125026_SeedInitialData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_27217_apbd_test2.Models.Entities.Artist", b =>
                {
            ...
            modelBuilder.Entity("_27217_apbd_test2.Models.Entities.Artwork", b =>
                {
            ...
            modelBuilder.Entity("_27217_apbd_test2.Models.Entities.Exhibition", b =>
                {
            ...
            modelBuilder.Entity("_27217_apbd_test2.Models.Entities.ExhibitionArtwork", b =>
                {
                    b.Property<int>("ExhibitionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_27217_apbd_test2.Models.Entities.Gallery", b =>
                {
                    b.Property<int>("GalleryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_27217_apbd_test2.Models.Entities.Artwork", b =>
                {
                    b.HasOne("_27217_apbd_test2.Models.Entities.Artist", "Artist")
                        .WithMany("Artworks")
            ...
            modelBuilder.Entity("_27217_apbd_test2.Models.Entities.Exhibition", b =>
                {
                    b.HasOne("_27217_apbd_test2.Models.Entities.Gallery", "Gallery")
            ...
            modelBuilder.Entity("_27217_apbd_test2.Models.Entities.ExhibitionArtwork", b =>
                {
                    b.HasOne("_27217_apbd_test2.Models.Entities.Artwork", "Artwork")
                        .WithMany("ExhibitionArtworks")
                        .HasForeignKey("ArtworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_27217_apbd_test2.Models.Entities.Exhibition", "Exhibition")
                        .WithMany("ExhibitionArtworks")
